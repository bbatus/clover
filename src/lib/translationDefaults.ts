...
export const TRANSLATION_DEFAULTS: Record<string, { tr: string; en: string }> = {
  ...
  "dashboardWidgets.recentTitle": { tr: "Son Güncellenen İçerikler", en: "Recently Updated Content" },
  "dashboardWidgets.recentEmpty": { tr: "Henüz bir içerik değişikliği yok.", en: "No content changes yet." },
  "dashboardWidgets.recentOpenCta": { tr: "Aç →", en: "Open →" },
